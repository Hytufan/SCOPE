...
class VISPRDataset(torch.utils.data.Dataset):
    def __init__(self, split, img_dir, filename_file_path, dict_file, roidb_file, transforms=None,
        ...
        #self.image_dir = '/workspace/huangyunyi/data/NIO/images/15/'
        #self.image_dir = ''
        self.filename_file= filename_file_path+f'{split}.txt'
        #self.filename_file='/workspace/huangyunyi/res/test.txt'
        ...
        self.obj_and_event= cfg.PROTECTED.OBJ # check object?
        ...
        if self.test_mode:
            ...
            self.filenames=[]
            target_list=[]
            with open('/workspace/huangyunyi/data/VISPR/anno/targets.json', 'r') as file:
            ...
            with open(self.filename_file, 'r') as file:
                for line in file:
                    ...
                    #target=line.split(' ')[1]
                    #target=int(target)
                    target=target_dict[os.path.basename(filename)]
    ...
    def __getitem__(self, idx):
        ...
        if self.obj_and_event:
            ...
            #img=apply_gaussian_blur(img,bbox,k=31)
