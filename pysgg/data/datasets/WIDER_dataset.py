...
class WIDERDataset(torch.utils.data.Dataset):
    def __init__(self, split, img_dir, filename_file_path, target_file_path, dict_file, roidb_file, transforms=None,
        ...
        if split=='train' or split=='test':
            self.target_file=target_file_path+f'{split}.json'
        elif split=='val':
            self.target_file=target_file_path+'train.json'
    ...
    def get_protect_target(self,index,img_size):
        ...
        protect_boxlist = BoxList(boxes_arr, img_size, mode='xywh')
