...
_C.MODEL.PROTECTED_DETECTION_ON = False
_C.MODEL.SCENE_ON = False
_C.MODEL.EVENT_ON = False
...
# ---------------------------------------------------------------------------- #
_C.PECONFIG = CN()
_C.PECONFIG.PROTECT_DATA_FILE = '/datapool/workspace/huangyunyi/data/vg/pro_obj_4.json'
_C.PECONFIG.USE_PROTECT_BOX = False
_C.PECONFIG.DROP_COVERED_OBJ = False
_C.PECONFIG.SERIES_PARALLEL = ''
_C.PECONFIG.USE_PROTECTED_OBJ_VISUAL_FEATURE = True
_C.PECONFIG.USE_PROTECT_UNION_MASK= False
_C.PECONFIG.UNION_BACKGROUND_RATE = 0.5
_C.PECONFIG.GET_AVG_FEATURE = False
_C.PECONFIG.USE_AVG_FEATURE = False
_C.PECONFIG.SEPARATE_UNION_MASK = False
_C.PECONFIG.NEW_ORDER = False
_C.PECONFIG.TRAIN_LABEL = False
_C.PECONFIG.HIDESEEKER = False
_C.PECONFIG.KG_EVENT=False
_C.PECONFIG.FEATURE_INPUT = ''

# ---------------------------------------------------------------------------- #
# PROTECTED
# ---------------------------------------------------------------------------- #
_C.PROTECTED = CN()
_C.PROTECTED.GGNN_N_NODES = 80
_C.PROTECTED.GGNN_N_EDGE_TYPES = 5
_C.PROTECTED.GGNN_D_STATE = 4096
_C.PROTECTED.GGNN_D_ANNOTATION = 2048
_C.PROTECTED.GGNN_N_STEPS = 2
_C.PROTECTED.FEATURE_DIM = 1024
_C.PROTECTED.NUM_CLASSES = 0
_C.PROTECTED.PROTECT_CLASSES = []
_C.PROTECTED.TRAINING = False
_C.PROTECTED.FEATURE = False
_C.PROTECTED.USE_WORD_EMBEDDING = False
_C.PROTECTED.TEST = False
_C.PROTECTED.OBJ = False
_C.PROTECTED.EVENT = False
_C.PROTECTED.MULTI_LABEL = False

# ---------------------------------------------------------------------------- #
# EVENT
# ---------------------------------------------------------------------------- #
_C.EVENT = CN()
_C.EVENT.TRAINING = False
_C.EVENT.NUM_CLASSES = 30
_C.EVENT.FROM_NODE_TYPE = 'obj'

# ---------------------------------------------------------------------------- #
# KGEVENT
# ---------------------------------------------------------------------------- #
_C.KGEVENT = CN()
_C.KGEVENT.GRAPH_PATH=''
_C.KGEVENT.EMB_PATH=''
_C.KGEVENT.HIDDEN_DIM=512
_C.KGEVENT.OBJ_TH=0.8
_C.KGEVENT.CLIP=True
_C.KGEVENT.EVENT_CLASSES=''
_C.KGEVENT.USE_KG=True
_C.KGEVENT.LEARNABLE_ADJ=False
_C.KGEVENT.EXPLAIN= ''
_C.KGEVENT.KG_PATH=''
_C.KGEVENT.ATTRIBUTE=False
_C.KGEVENT.PRIVACY_SCORE=False
_C.KGEVENT.BACKGROUND_ON=False