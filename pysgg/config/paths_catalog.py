...
class DatasetCatalog(object):
    DATA_DIR = "/workspace/huangyunyi/data/"
    DATASETS = {
        "coco_2017_train": {
        ...
        "WIDER":{
            "img_dir":"WIDER/image/",
            "filename_file_path":"WIDER/",
            "target_file_path":"WIDER/wider_attribute_annotation/wider_event_protect_",
            "dict_file": "vg/VG-SGG-dicts-with-attri.json",
            "roidb_file": "vg/VG-SGG-with-attri.h5",
        },
        "EVENT61":{
            "img_dir":"",
            "filename_file_path":"WIDER_v0.1/",
            #"target_file_path":"WIDER/wider_attribute_annotation/wider_event_protect_",
            "dict_file": "vg/VG-SGG-dicts-with-attri.json",
            "roidb_file": "vg/VG-SGG-with-attri.h5",
        },
        "MYEVENT":{
            "img_dir":"MyEventDataset/images/",
            "filename_file_path":"MyEventDataset/",
            #"target_file_path":"WIDER/wider_attribute_annotation/wider_event_protect_",
            "dict_file": "vg/VG-SGG-dicts-with-attri.json",
            "roidb_file": "vg/VG-SGG-with-attri.h5",
        },
    ...
    def get(name, cfg):
        if "coco" in name:
            ...
            args['flip_aug'] = cfg.MODEL.FLIP_AUG
            return dict(
                factory="EVENT61Dataset",
                args=args,
            )
        elif ("MYEVENT" in name):
            p = name.rfind("_")
            name, split = name[:p], name[p + 1:]
            assert name in DatasetCatalog.DATASETS and split in {'train', 'val', 'test'}
            data_dir = DatasetCatalog.DATA_DIR
