...
class RelationLossComputation(object):
    ...
    def __call__(self, proposals, rel_labels, relation_logits, refine_logits):
        ...
        is_protect = cat([proposal.get_field("is_protect") for proposal in proposals], dim=0)
        filter_fg_labels = fg_labels[is_protect != 0]
        filter_refine_obj_logits=refine_obj_logits[is_protect != 0]
        #print()

        #loss_refine_obj = self.criterion_loss(refine_obj_logits, fg_labels.long())
        loss_refine_obj = self.criterion_loss(filter_refine_obj_logits, filter_fg_labels.long())
    ...
    def label_loss(self,proposals, refine_logits):
        refine_obj_logits = refine_logits
        refine_obj_logits = cat(refine_obj_logits, dim=0)
        ...
        #print(is_protect,filter_refine_obj_logits, filter_fg_labels)
